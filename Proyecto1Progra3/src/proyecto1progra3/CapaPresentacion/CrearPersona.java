...
Profesores Elg = new Profesores();
 String Nombre;
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
          Elg.Agregar(jTFName.getText(), jTFA1.getText(), jTXA2.getText(),jTFDNI.getText() , jTXCarne.getText(), Integer.parseInt(jTXages.getText()), jTextField1.getText(), jTextField2.getText(),Integer.parseInt(jTextField3.getText()), jTextField4.getText(),jTextField5.getText(),jTextField6.getText(), jTextField7.getText());
        limpiarDataAlumno();
        showTable();
